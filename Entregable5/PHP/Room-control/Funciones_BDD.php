<?php
	...
	class Funciones_BDD{
		...
		public function obtenerUsuarioExistente($idUs){
			$query= "SELECT IdUsuario, Contraseña FROM Usuario WHERE IdUsuario='$idUs'";
			try{
				$comando= Conexion::getDB()->prepare($query);
				$comando->execute();				
				return $comando->fetchAll(PDO::FETCH_ASSOC);
		...
		public function obtenerNomColumnas($tabla){
